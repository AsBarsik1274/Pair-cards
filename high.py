...
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
COLORS = [(139, 69, 19),(0, 255, 255),(255, 0, 0), (0, 255, 0), (0, 0, 255), (255, 255, 0), (255, 0, 255), (0, 255, 255), (36, 34, 109), (255, 125, 3), (138, 207, 190), (207, 138, 193),(221,160,221), (240, 230, 140), (165, 42, 42), (188, 143, 143),(210, 180, 140), (75, 0, 130), (25, 25, 112), (128, 128, 0)]
    ...
    for row in range(GRID_ROWS):
        for col in range(GRID_COLS):
            ...
            if index < len(colors):
                card = {
                    'color': colors[index],
                    'rect': pygame.Rect(col * (CARD_WIDTH + 5) + 30, row * (CARD_HEIGHT + 5) + 30,
...
def draw_cards(grid):
    ...
    screen.blit(text, (1670, 50))
    text2 = font.render('Attemps: ' + str(15- attempts_false), True, THECOLORS['orange'])
    screen.blit(text2, (1670, 90))
